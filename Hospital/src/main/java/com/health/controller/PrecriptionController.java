...
public class PrecriptionController {
	...
	public Precription getAllPrecriptionbyusername(@PathVariable("username") String username) {
		
		Precription precription = precriptionRepository.findByUsername(username);
		return precription;
	}
